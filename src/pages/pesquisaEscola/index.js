...
<div className=" flex flex-col justify-center md: py-9  px-4">
      <div className=' flex justify-center text-center'>
        <h1 className='font-loto font-bold  text-letras2  py-4 text-xl'>Encontre sua instituição de ensino</h1>
      </div>
...
<div className=" flex flex-col justify-center text-center items-center p-1">
<Scrollbars style={{ width: 640, height: 265 }} >
  <div className="bg-white shadow-md rounded my-6 ">
    <table className="text-left border-collapse w-[15rem] md:w-[40rem]"> 
      <thead>
        <tr className=' w-[15rem] md:w-[40rem] px-0  '>
      ...
      return(
      <tbody>
        <tr className="hover:bg-grey-lighter w-[15rem] md:w-[40rem] " key={escola.PRV_ID}>
 ...
 {escolaC && (
     <div className=' flex flex-row justify-center'>
        <input
           className='flex rounded-xl m-1  w-64 md:w-[33rem] ponteiro-eventos-auto bg-Base1  h-10 text-center uppercase place-content-center font-abc focus:outline-none cursor-text'
            type='text'
           placeholder='Digite o nome do aluno'
           value={inputAluno}
           onChange={(e) => setInputAluno(e.target.value)}/>
      <br/>
        <button className='w-24  h-10  mt-1 text-green-dark font-bold py-1 px-3 rounded-xl  bg-green hover:bg-letras2 hover:text-2 cursor-pointer' onClick={handleAlunoClick}>Consultar</button>
